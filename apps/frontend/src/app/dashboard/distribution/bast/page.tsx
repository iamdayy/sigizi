  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-white/80 border border-slate-200 rounded-2xl p-6 shadow-xl backdrop-blur-xl">
          ...
          <form onSubmit={handleGenerate} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full bg-slate-50/70 border border-slate-200 focus:border-brand-primary focus:ring-1 focus:ring-blue-500 rounded-xl pl-10 pr-4 py-2.5 text-sm text-brand-dark outline-none transition-all"
                >
                  {schools?.map((s) => (
                    <option key={s.id} value={s.id} className="bg-white text-brand-dark">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-slate-50/70 border border-slate-200 focus:border-brand-primary rounded-xl pl-10 pr-3 py-2 text-xs text-brand-dark outline-none"
                  />
                </div>
              </div>
              <div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-slate-50/70 border border-slate-200 focus:border-brand-primary rounded-xl px-3.5 py-2 text-xs text-brand-dark outline-none"
              />
            </div>
          ...
          {generatedDoc && (
            <div className="mt-5 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-200">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center space-x-2 px-3 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-brand-dark text-xs font-semibold shadow-md transition-colors"
              >
        ...
        <div className="lg:col-span-7 bg-white/80 border border-slate-200 rounded-2xl p-6 shadow-xl backdrop-blur-xl flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-blue-500/10 text-brand-primary border border-brand-primary/20">
            ...
            <div className="grid grid-cols-3 gap-3 mb-5">
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                <span className="text-[11px] text-slate-500 font-medium">Total Porsi</span>
                <p className="text-base font-bold text-brand-dark mt-0.5">
                  {previewData?.total_portions.toLocaleString('id-ID') || 0} Porsi
                </p>
              </div>
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                <span className="text-[11px] text-slate-500 font-medium">Total Nilai Alokasi</span>
                <p className="text-base font-bold text-emerald-600 mt-0.5">
                  {formatIDR(previewData?.total_amount || 0)}
                </p>
              </div>
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                <span className="text-[11px] text-slate-500 font-medium">Sasaran Siswa</span>
            ...
            <div className="overflow-x-auto border border-slate-100 rounded-xl bg-slate-50/40">
              <table className="w-full text-left text-xs">
                <thead>
                  <tr className="border-b border-slate-200 text-slate-500 font-semibold uppercase tracking-wider bg-white shadow-sm">
                ...
                <tbody className="divide-y divide-slate-100/50 text-slate-600">
                  {isPreviewLoading ? (
                    ...
                    previewData.deliveries.map((d: Distribution) => (
                      <tr key={d.id} className="hover:bg-slate-100/20 transition-colors">
                        ...
                        <td className="py-2.5 px-3 text-right font-bold text-brand-dark">
                          {d.total_portions}
                        </td>
                        <td className="py-2.5 px-3 text-center">
                          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-blue-500/10 text-brand-primary border border-blue-500/20">
                            {d.status}
                          </span>
                        </td>
                      </tr>
          ...
          <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
            ...
            <span className="text-slate-600 font-medium">Format Resmi Badan Gizi Nasional (BGN)</span>
          </div>
        </div>
      </div>

      {/* Historical BAST Archive Table */}
      <div className="bg-white/80 border border-slate-200 rounded-2xl p-6 shadow-xl backdrop-blur-xl">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-base font-bold text-slate-100">
                  ...
                  <tr key={doc.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="py-3.5 pl-4 text-right">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-brand-primary/10 hover:bg-brand-primary/30 border border-brand-primary/20 text-blue-300 text-xs font-semibold transition-colors"
                      >
                        <Download className="w-3.5 h-3.5" />
                        <span>Unduh PDF</span>
                      </a>
