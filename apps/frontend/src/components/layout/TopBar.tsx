    ...
    <header className="h-16 border-b border-slate-800 bg-slate-900/60 backdrop-blur-xl px-6 flex items-center justify-between sticky top-0 z-20">
      ...
      <div className="flex items-center space-x-6 text-xs text-slate-400">
        <div className="flex items-center space-x-2 bg-slate-800/50 px-3 py-1.5 rounded-lg border border-slate-700/50">
          ...
          <span className="text-slate-300 font-medium">{formatDate(todayStr)}</span>
        </div>
        <div className="hidden md:flex items-center space-x-2 bg-slate-800/50 px-3 py-1.5 rounded-lg border border-slate-700/50">
          ...
          <span className="text-slate-300 font-medium">Zona Waktu: Asia/Jakarta (WIB)</span>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative group">
          <button
            ...
            className="p-2 rounded-xl text-slate-400 hover:text-slate-200 hover:bg-slate-800/80 border border-slate-800 transition-all duration-150 relative"
          >
          ...
          {/* Dropdown Menu */}
          <div className="hidden group-hover:block absolute right-0 mt-2 w-80 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-4 z-50 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <span className="text-xs font-semibold text-white">Notifikasi SPPG</span>
        ...
        {/* User Info Capsule */}
        <div className="flex items-center space-x-3 bg-slate-800/60 border border-slate-700/60 px-3 py-1.5 rounded-xl">
        ...
        <button
          ...
          className="p-2 rounded-xl text-slate-400 hover:text-red-400 hover:bg-red-500/10 border border-slate-800 hover:border-red-500/30 transition-all duration-150"
        >
